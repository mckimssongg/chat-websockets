...
function App() {
  ...
  const nombresSalas = ["sala1", "kakao", "test"];
  ...
  React.useEffect(() => {
    ...
    chatSocket.onerror = function (evt) {
      console.log("WebSocket error: " + Object.values(evt));
    }

  }, []);

  chatSocket.onmessage = (mensaje) => {
    const dataFromServer = JSON.parse(mensaje.data);
    console.log(dataFromServer);
    if (dataFromServer) {
      setConversacion(conversacion + dataFromServer.message);
    }
  };
